...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+ueD3Bu8ITmk3NGE1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002389254480').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jagdish1020:jagdish1020@jagdish1020.sexyq.mongodb.net/?retryWrites=true&w=majority&appName=jagdish1020")
DATABASE_NAME = environ.get('DATABASE_NAME', "jagdish1020")
